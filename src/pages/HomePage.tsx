...
// // Helper to get Country-specific Landmark images from Unsplash
// const getCountryImageUrl = (country) => {
//   const imageMap = {
//     "USA": "https://images.unsplash.com/photo-1485738422979-f5c462d49f74?q=80&w=600&auto=format&fit=crop", // NYC
//     "UK": "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=600&auto=format&fit=crop", // London
//     "Canada": "https://images.unsplash.com/photo-1503614472-8c93d56e92ce?q=80&w=600&auto=format&fit=crop", // Mountains
//     "Australia": "https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?q=80&w=600&auto=format&fit=crop", // Sydney
...
//     "Germany": "https://images.unsplash.com/photo-1467269204594-9661b134dd2b?q=80&w=600&auto=format&fit=crop",
//     "France": "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=600&auto=format&fit=crop", // Eiffel
//     "Singapore": "https://thumbs.dreamstime.com/b/singapore-national-day-helicopter-hanging-flag-flying-over-city-100128629.jpg",
//     "UAE": "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?q=80&w=600&auto=format&fit=crop", // Dubai
//     "Japan": "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=600&auto=format&fit=crop",
//   };

//   // If country is not in map, search Unsplash dynamically for that country's travel photo
//   return imageMap[country] || `https://source.unsplash.com/featured/?${encodeURIComponent(country)},landmark,architecture`;
// };
...
//       {/* Countries Section - HIGH QUALITY COUNTRY IMAGES */}
...
//               to="/contact" 
//               key={c} 
//               className="group relative h-48 rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500"
//             >
...
//               {/* Country Name Centered at bottom */}
//               <div className="absolute bottom-4 left-0 right-0 text-center">
//                 <span className="text-sm font-bold text-white tracking-widest uppercase group-hover:text-gold transition-colors drop-shadow-md">
//                   {c}
//                 </span>
//               </div>
//             </Link>
...
//       {/* Rest of sections (Visa, Stats, Testimonials, CTA) */}
//       <section className="section-padding bg-background">
...
// // ... other constants and functions kept same as previous ...
// const heroSlides = [
...
//   { image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=800&auto=format&fit=crop", title: "Application Support", desc: "End-to-end application and documentation assistance" },
// ];
