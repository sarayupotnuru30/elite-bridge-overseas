...
//         scrolled ? "bg-navy/95 backdrop-blur-lg shadow-lg py-1" : "bg-transparent py-3"
//       }`}
//     >
//       <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
//         <Link to="/" className="flex items-center gap-3">
//           {/* Increased logo size: h-16 on mobile and h-20 on larger screens */}
//           <img 
//             src={logo} 
//             alt="Elite Bridge Overseas" 
//             className="h-16 md:h-20 w-auto transition-all duration-500" 
//           />
//           <span className="text-gold-gradient font-serif text-xl md:text-2xl font-bold hidden sm:block">
//             Elite Bridge
//           </span>
//         </Link>
...
//                 location.pathname === l.to ? "text-gold" : "text-cream hover:text-gold"
//               }`}
//             >
//               {l.label}
//             </Link>
